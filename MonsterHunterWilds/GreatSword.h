#pragma once
#include "GreatSword.g.h"

namespace winrt::MonsterHunterWilds::implementation
{
    struct GreatSword : GreatSwordT<GreatSword>
    {
        static winrt::MonsterHunterWilds::GreatSword Parse(winrt::Windows::Data::Json::JsonObject const& json_object);
...
{
    struct GreatSword : GreatSwordT<GreatSword, implementation::GreatSword>
    {
    };
}
