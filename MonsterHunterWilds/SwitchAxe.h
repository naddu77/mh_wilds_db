...
namespace winrt::MonsterHunterWilds::implementation
{
    ...
    private:
        winrt::MonsterHunterWilds::Phial phial_;
        int32_t id_;
        int32_t game_id_;
...
{
    struct SwitchAxe : SwitchAxeT<SwitchAxe, implementation::SwitchAxe>
    {
    };
}
