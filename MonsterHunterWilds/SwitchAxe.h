...
namespace winrt::MonsterHunterWilds::implementation
{
    ...
    private:
        winrt::MonsterHunterWilds::SwitchAxePhial phial_;
        int32_t id_;
        int32_t game_id_;
