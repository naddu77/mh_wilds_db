#pragma once
#include "HuntingHorn.g.h"

namespace winrt::MonsterHunterWilds::implementation
{
    struct HuntingHorn : HuntingHornT<HuntingHorn>
    {
        HuntingHorn(int32_t id, int32_t game_id, winrt::MonsterHunterWilds::WeaponKind const& kind, hstring const& name, int32_t rarity, winrt::MonsterHunterWilds::WeaponDamage const& damage, winrt::Windows::Foundation::Collections::IVector<winrt::MonsterHunterWilds::WeaponSpecial> const& specials, winrt::MonsterHunterWilds::Sharpness const& sharpness, winrt::Windows::Foundation::Collections::IVector<int32_t> const& handicraft, winrt::Windows::Foundation::Collections::IVector<winrt::MonsterHunterWilds::SkillRank> const& skills, int32_t defense_bonus, winrt::MonsterHunterWilds::Elderseal const& elderseal, int32_t affinity, winrt::Windows::Foundation::Collections::IVector<int32_t> const& slots, winrt::MonsterHunterWilds::WeaponCrafting const& crafting, winrt::MonsterHunterWilds::WeaponSeries const& series, winrt::MonsterHunterWilds::HuntingHornMelody const& melody, winrt::MonsterHunterWilds::HuntingHornBubble const& echo_bubble, winrt::MonsterHunterWilds::HuntingHornWave const& echo_wave);
        
        winrt::MonsterHunterWilds::HuntingHornMelody Melody();
        winrt::MonsterHunterWilds::HuntingHornBubble EchoBubble();
        winrt::MonsterHunterWilds::HuntingHornWave EchoWave();
        int32_t Id();
        int32_t GameId();
    ...
    private:
        winrt::MonsterHunterWilds::HuntingHornMelody melody_;
        winrt::MonsterHunterWilds::HuntingHornBubble echo_bubble_;
        winrt::MonsterHunterWilds::HuntingHornWave echo_wave_;
        int32_t id_;
        int32_t game_id_;
...
{
    struct HuntingHorn : HuntingHornT<HuntingHorn, implementation::HuntingHorn>
    {
    };
}
