...
namespace winrt::MonsterHunterWilds::implementation
{
    ...
    {
        static winrt::MonsterHunterWilds::HuntingHorn Parse(winrt::Windows::Data::Json::JsonObject const& json_object);        
        ...
        HuntingHorn(
            ...
            int32_t affinity, winrt::Windows::Foundation::Collections::IVector<int32_t> const& slots,
