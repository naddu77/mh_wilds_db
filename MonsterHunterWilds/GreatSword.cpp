...
#include "GreatSword.g.cpp"

namespace winrt::MonsterHunterWilds::implementation
{
    winrt::MonsterHunterWilds::GreatSword GreatSword::Parse(winrt::Windows::Data::Json::JsonObject const& json_object)
    {
        return {
    ...
    int32_t GreatSword::Id()
    {
        return id_;
    }

    int32_t GreatSword::GameId()
    {
        return game_id_;
    }

    winrt::MonsterHunterWilds::WeaponKind GreatSword::Kind()
    {
        return kind_;
    }

    hstring GreatSword::Name()
    {
        return name_;
    }

    int32_t GreatSword::Rarity()
    {
        return rarity_;
    }

    winrt::MonsterHunterWilds::WeaponDamage GreatSword::Damage()
    {
        return damage_;
    }

    winrt::Windows::Foundation::Collections::IVector<winrt::MonsterHunterWilds::WeaponSpecial> GreatSword::Specials()
    {
        return specials_;
    }

    winrt::MonsterHunterWilds::Sharpness GreatSword::Sharpness()
    {
        return sharpness_;
    }

    winrt::Windows::Foundation::Collections::IVector<int32_t> GreatSword::Handicraft()
    {
        return handicraft_;
    }

    winrt::Windows::Foundation::Collections::IVector<winrt::MonsterHunterWilds::SkillRank> GreatSword::Skills()
    {
        return skills_;
    }

    int32_t GreatSword::DefenseBonus()
    {
        return defense_bonus_;
    }

    winrt::Windows::Foundation::IReference<winrt::MonsterHunterWilds::Elderseal> GreatSword::Elderseal()
    {
        return elderseal_;
    }

    int32_t GreatSword::Affinity()
    {
        return affinity_;
    }

    winrt::Windows::Foundation::Collections::IVector<int32_t> GreatSword::Slots()
    {
        return slots_;
    }

    winrt::MonsterHunterWilds::WeaponCrafting GreatSword::Crafting()
    {
        return crafting_;
    }

    winrt::MonsterHunterWilds::WeaponSeries GreatSword::Series()
    {
        return series_;
    }
}
