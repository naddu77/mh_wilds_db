...
{
    winrt::MonsterHunterWilds::LightBowgun LightBowgun::Parse(winrt::Windows::Data::Json::JsonObject const& json_object)
    {
        return {
            ...
            winrt::MonsterHunterWilds::LightBowgunAmmo::ParseJsonArray(json_object.GetNamedArray(L"ammo")),
            winrt::MonsterHunterWilds::EnumMap::LightBowgunSpecialAmmoMap(json_object.GetNamedString(L"specialAmmo"))
        };
    }
    ...
    winrt::Windows::Foundation::IReference<winrt::MonsterHunterWilds::Elderseal>  LightBowgun::Elderseal()
    {
        return elderseal_;
    }
