#pragma once
#include "Gunlance.g.h"

namespace winrt::MonsterHunterWilds::implementation
{
    struct Gunlance : GunlanceT<Gunlance>
    {
        static winrt::MonsterHunterWilds::Gunlance Parse(winrt::Windows::Data::Json::JsonObject const& json_object);

        Gunlance(int32_t id, int32_t game_id, winrt::MonsterHunterWilds::WeaponKind const& kind, hstring const& name, int32_t rarity, winrt::MonsterHunterWilds::WeaponDamage const& damage, winrt::Windows::Foundation::Collections::IVector<winrt::MonsterHunterWilds::WeaponSpecial> const& specials, winrt::MonsterHunterWilds::Sharpness const& sharpness, winrt::Windows::Foundation::Collections::IVector<int32_t> const& handicraft, winrt::Windows::Foundation::Collections::IVector<winrt::MonsterHunterWilds::SkillRank> const& skills, int32_t defense_bonus, winrt::Windows::Foundation::IReference<winrt::MonsterHunterWilds::Elderseal> const& elderseal, int32_t affinity, winrt::Windows::Foundation::Collections::IVector<int32_t> const& slots, winrt::MonsterHunterWilds::WeaponCrafting const& crafting, winrt::MonsterHunterWilds::WeaponSeries const& series, winrt::MonsterHunterWilds::GunlanceShell const& shell, int32_t shell_level);
        
        winrt::MonsterHunterWilds::GunlanceShell Shell();
        int32_t ShellLevel();
        int32_t Id();
        int32_t GameId();
    ...
    private:
        winrt::MonsterHunterWilds::GunlanceShell shell_;
        int32_t shell_level_;
        int32_t id_;
        int32_t game_id_;
...
{
    struct Gunlance : GunlanceT<Gunlance, implementation::Gunlance>
    {
    };
}
